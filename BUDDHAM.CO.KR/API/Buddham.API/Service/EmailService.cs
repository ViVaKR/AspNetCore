...
public class EmailService(IConfiguration config) : IEmailService
{
    ...
    {
        string? MailServer = _config["EmailSettings:MailServer"] ?? "smtp.gmail.com";
        string? FromEmail = _config["EmailSettings:FromEmail"] ?? "viv.buddha@gmail.com";
        string? Password = _config["EmailSettings:Password"] ?? "xnlx kwjr unqd jgxd";
        int Port = Convert.ToInt32(_config["EmailSettings:MailPort"] ?? "587");
